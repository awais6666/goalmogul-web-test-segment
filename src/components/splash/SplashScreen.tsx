 ...
 */
export default class SplashScreen extends React.Component<PropsInterface> {
  state = {
    hasInviteCode: false,
    inviter: {
      firstName: "",
      ...
      <main className={styles.splashMain}>
        ...
        <section className={styles.sectionOne}>
          <div className={styles.sectionContent}>
            ...
            <h1>
              Keep in touch and grow closer to your friends than ever before...
              {/* </Typist> */}
            </h1>
            {/* <Typist.Delay ms={500} /> */}
            <h2>
              Find out what your friends' goals are in life and enjoy helping
              each other.
            </h2>
            {/* </Typist> */}
          </div>
          ...
          <div className={styles.sectionContent}>
            <div className={styles.textWrapper}>
              <div className={styles.inputDiv}>
                ...
                >
                  <p>
                    Do the most important thing in a friendship...
                    <br />
                    Help each other grow
                    <br />
                    <b>Join the #1 Goal Sharing Social Network</b>
                    <br />
                    App Launching Soon
                  </p>
                </ScrollAnimation>
                ...
                >
                  <p className={styles.textWrapper2}>
                    <b>SIGN UP TODAY for a chance to win $100!</b>
                    <br />
            ...
            <div className={styles.imageWrapper}>
              {/* <ScrollAnimation
                ...
                animateOnce={true}
              > */}
              <div className={styles.wireframe1Splash}>
                <div
                  id='wireframe1contentDiv'
                  className={styles.wireframe1contentDiv}
                >
                  <img
                    className={styles.wireframe1content}
                    src={frameContent}
                    alt=''
                  />
                </div>
                <div className={styles.wireframe1mainDiv}>
                  <img
                    className={styles.wireframe1frame}
                    src={frameMob}
                    alt=''
                  />
                </div>
            ...
            <div className={styles.textWrapper}>
              ...
              >
                <p>
                  ...
                  <div>
                    {" "}
                    Discover what all your friends are trying to achieve... in
                ...
                <p>
                  ...
                  <div>
                    {" "}
                    Be the best friend you can be by helping each other
                    accomplish more
                  </div>
                </p>
                <p>
                  <div>🔥 </div>
                  <div> Avoid losing touch with what they want in life</div>
                </p>
                <p>
                  <div>🔥 </div>
                  <div> Give your friendships more meaning</div>
                </p>
              </ScrollAnimation>
            </div>
          </div>
          ...
          <div className={styles.sectionContent}>
            <div className={styles.textWrapper}>
              ...
              >
                <p>
                  <div>🔥 </div>
                  <div> Not sure what new goals to set?</div>
                </p>
                <p>
                  <div>🔥 </div>
                  <div>
                    {" "}
                    Revolutionary Goal Planner designed to help you{" "}
                    <br className={styles.hideMob} /> discover new passions{" "}
                  </div>
                </p>
                <p>
                  <div>🔥 </div>
                  <div> Get clear about what you really want </div>
                </p>
                <p>
                  <div>🔥 </div>
                  <div>
                    {" "}
                    Set goals that make you want to jump out of bed every
                    morning{" "}
                  </div>
                </p>
                <p>
                  ...
                  <div>
                    {" "}
                    Get proven strategies to help you crush self-doubt{" "}
                  </div>
                </p>
              </ScrollAnimation>
            </div>
          ...
          <div className={styles.sectionContent}>
            ...
            <div className={styles.textWrapper}>
              ...
              >
                <p>
                  <div>🔥 </div>
                  <div> Break your big goals into smaller steps </div>
                </p>
                <p>
                  <div>🔥 </div>
                  <div> Prioritize, categorize, and set deadlines </div>
                </p>
                <p>
                  <div>🔥 </div>
                  <div> List your Needs so others can help </div>
                </p>
                <p>
                  <div>🔥 </div>
                  <div> Get reminders and motivation to keep you on track </div>
                </p>
              </ScrollAnimation>
            </div>
          </div>
          ...
          <div className={styles.sectionContent}>
            <div className={styles.textWrapper}>
              ...
              >
                <p>
                  <div>🔥 </div>
                  <div> Mastermind with personal development enthusiasts </div>
                </p>
                <p>
                  <div>🔥 </div>
                ...
                <p>
                  <div>🔥 </div>
                  <div> Network with a purpose </div>
                </p>
                <p>
                  <div>🔥 </div>
                  <div> Surround yourself with positive mental attitudes </div>
                </p>
              </ScrollAnimation>
            </div>
          ...
          <div className={styles.sectionContent}>
            ...
            <div className={styles.textWrapper}>
              <p>
                ...
                <br />
                <h3>We'll email you when the app is ready.</h3>
              </p>
              <div className={styles.inputContainer}>
                <input
                  placeholder='Email address'
                ...
                />
                <button onClick={this.subscribe}>Join WaitList</button>
              </div>
