  ...
  render() {
    return (
      <main className={styles.main}>
        <Helmet>
          <title>
            Productivity and Social Networking App for Goal Oriented Achievers |
            Digital Life Coach | GoalMogul
          </title>
          <meta
            name='description'
            content="#1 App for Goal-Oriented Achievers | GoalMogul's Digital Life Coaches will help you set personal goals, boost your confidence, and change your life. Download Free"
          />
          <meta
            name='keywords'
            content='life coach apps, apps for life coaches, goal oriented apps, goal planner online, personal goal planner'
          />
          <link rel='canonical' href='https://www.goalmogul.com/terms ' />
        </Helmet>
        ...
        <p>
          ...
          and others which may interact or interface with GoalMogul Inc., also
          known as GoalMogul, located at 143-26 41st Ave, #3B, Flushing, New
          York 11355 and our subsidiaries and affiliates, in association with
          the use of the GoalMogul website, which includes
          http://www.goalmogul.com, (the "Site") and its Services, which shall
          be defined below.
        </p>
        <p>
          <h3>DESCRIPTION OF WEBSITE SERVICES OFFERED</h3>
          The Site is a social networking website which has the following
          description: GoalMogul provides web-based services for social
          networking and utility applications for goal planning, goal sharing,
          personal development, motivation, and achievement. Any and all
          visitors to our site, despite whether they are registered or not,
          shall be deemed as "users" of the herein contained Services provided
          for the purpose of this TOS. Once an individual register's for our
          Services, through the process of creating an account, the user shall
          then be considered a "member."
        </p>
        <p>
          The user and/or member acknowledges and agrees that the Services
          provided and made available through our website and applications,
          which may include some mobile applications and that those applications
          may be made available on various social media networking sites and
          numerous other platforms and downloadable programs, are the sole
          property of GoalMogul Inc. At its discretion, GoalMogul Inc may offer
          additional website Services and/or products, or update, modify or
          revise any current content and Services, and this Agreement shall
          apply to any and all additional Services and/or products and any and
          all updated, modified or revised Services unless otherwise stipulated.
          GoalMogul Inc does hereby reserve the right to cancel and cease
          offering any of the aforementioned Services and/or products. You, as
          the end user and/or member, acknowledge, accept and agree that
          GoalMogul Inc shall not be held liable for any such updates,
          ...
          modifications, and as such, frequent review of this Agreement and any
          and all applicable terms and policies should be made by you to ensure
          you are aware of all terms and policies currently in effect. Should
          you not agree to the updated, revised or modified terms, you must stop
          using the provided Services forthwith.
        </p>
        <p>
          Furthermore, the user and/or member understands, acknowledges and
          agrees that the Services offered shall be provided "AS IS" and as such
          GoalMogul Inc shall not assume any responsibility or obligation for
        ...
        <p>
          <h5>REGISTRATION</h5>
          To register and become a "member" of the Site, you must be at least 18
          years of age to enter into and form a legally binding contract. In
          addition, you must be in good standing and not an individual that has
          been previously barred from receiving GoalMogul's Services under the
          laws and statutes of the United States or other applicable
          jurisdiction.
        </p>
        <p>
          When you register, GoalMogul may collect information such as your
          name, e-mail address, birth date, gender, mailing address, occupation,
          industry and personal interests. You can edit your account information
          at any time. Once you register with GoalMogul and sign in to our
        ...
        <p>
          ...
          inaccurate or incomplete nature, GoalMogul Inc will have sufficient
          ...
          or future use of GoalMogul Inc Services, or any portion thereof.
        </p>
        <p>
          It is GoalMogul Inc's priority to ensure the safety and privacy of all
          its visitors, users and members, especially that of children.
          Therefore, it is for this reason that the parents of any child under
          the age of 13 that permit their child or children access to the
          GoalMogul website platform Services must create a "family" account,
          which will certify that the individual creating the "family" account
          is of 18 years of age and as such, the parent or legal guardian of any
          child or children registered under the "family" account. As the
          creator of the "family" account, s/he is thereby granting permission
          for his/her child or children to access the various Services provided,
          including, but not limited to, message boards, email, and/or instant
          messaging. It is the parent's and/or legal guardian's responsibility
          to determine whether any of the Services and/or content provided are
          age-appropriate for his/her child.
        </p>
        <p>
          <h5>PRIVACY POLICY</h5>
          Every member's registration data and various other personal
          information are strictly protected by the GoalMogul Inc Online Privacy
          Policy (see the full Privacy Policy at
          http://www.goalmogul.com/privacy
        </p>
        <p>
          ...
          United States and/orother countries for storage, processing or use by
          GoalMogul Inc and/or our subsidiaries and affiliates.
        </p>
        <p>
          <h5>MEMBER ACCOUNT, USERNAME, PASSWORD AND SECURITY</h5>
          ...
          confidentiality of your password and for all activities that transpire
          on or within your account. It is your responsibility for any act or
          omission of any user(s) that access your account information that, if
          undertaken by you, would be deemed a violation of the TOS. It shall be
          your responsibility to notify GoalMogul Inc immediately if you notice
          any unauthorized access or use of your account or password or any
          other breach of security. GoalMogul Inc shall not be held liable for
          any loss and/or damage arising from any failure to comply with this
        ...
        <p>
          ...
          available by way of the GoalMogul Services, and as such, we do not
          ...
          otherwise made available by GoalMogul. Furthermore, you herein agree
          not to make use ofGoalMogul Inc's Services for the purpose of:
        </p>
        <p>
        ...
        <p>
          c) impersonating any individual or entity, including, but not limited
          to, anyGoalMogul officials, forum leaders, guides or hosts or falsely
        ...
        <p>
          ...
          pursuant to any law or in accordance with any contractual or fiduciary
          relationship;
        </p>
        <p>
          g) uploading, posting, emailing, transmitting, or otherwise offering
          any unsolicited or unauthorized advertising, promotional flyers, "junk
        ...
        <p>
          ...
          destroy and/or limit the operation of any computer software, hardware,
        ...
        <p>
          j) interfering with or disrupting any GoalMogul Inc Services, servers
        ...
        <p>
          ...
          rules, guidelines, and/or regulations decreed by the U.S. Securities
          and Exchange Commission, in addition to any rules of any nation or
          other securities exchange, that would include without limitation, the
        ...
        <p>
          ...
          organization" in accordance to Section 219 of the Immigration
          Nationality Act;
        </p>
        <p>
        ...
        <p>
          GoalMogul Inc herein reserves the right to pre-screen, refuse and/or
        ...
        <p>
          GoalMogul Inc herein reserves the right to access, preserve and/or
        ...
        <p>
          e) protecting the rights, property or the personal safety ofGoalMogul
          Inc, its visitors, users and members, including the general public.
        </p>
        <p>
          GoalMogul Inc herein reserves the right to include the use of security
          ...
          to usage guidelines and regulations established by GoalMogul Inc or
          any other content providers supplying content services to GoalMogul
          Inc. You are hereby prohibited from making any attempt to override or
        ...
        <p>
          <h5>INTERSTATE COMMUNICATION</h5>
          Upon registration, you hereby acknowledge that by using
          http://www.goalmogul.com to send electronic communications, which
          would include, but are not limited to, email, searches, instant
          messages, uploading of files, photos and/or videos, you will be
          causing communications to be sent through our computer network.
        ...
        <p>
          ...
          GoalMogul Inc shall not lay claim to ownership of any content
          ...
          grant and allow for GoalMogul Inc the below listed worldwide,
          royalty-free and non- exclusive licenses, as applicable:
        </p>
        <p>
          a) The content submitted or made available for inclusion on the
          publicly accessible areas of GoalMogul Inc's sites, the license
          ...
          member of GoalMogul Inc's sites, and shall terminate at such time when
          you elect to discontinue your membership.
        </p>
        <p>
          b) Photos, audio, video and/or graphics submitted or made available
          for inclusion on the publicly accessible areas of GoalMogul Inc's
          ...
          made available for viewing. This license shall be available so long as
          you are a member of GoalMogul Inc's sites and shall terminate at such
          time when you elect to discontinue your membership.
        </p>
        <p>
          c) For any other content submitted or made available for inclusion on
          the publicly accessible areas of GoalMogul Inc's sites, the
        ...
        <p>
          Those areas which may be deemed "publicly accessible" areas
          ofGoalMogul Inc's sites are those such areas of our network properties
          which are meant to be available to the general public, and which would
          include message boards and groups that are openly available to both
          users and members. However, those areas which are not open to the
          public, and thus available to members only, would include our mail
          system and instant messaging.
        </p>
        <p>
          <h5>CONTRIBUTIONS TO COMPANY WEBSITE</h5>
          GoalMogul Inc provides an area for our users and members to contribute
        ...
        <p>
          b) GoalMogul shall not be liable or under any obligation to ensure or
          maintain confidentiality, expressed or implied, related to any
          Contributions;
        </p>
        <p>
          c) GoalMogul shall be entitled to make use of and/or disclose any such
        ...
        <p>
          ...
          property ofGoalMogul; and
        </p>
        <p>
          e) GoalMogul is under no obligation to either compensate or provide
          any form of reimbursement in any manner or nature.
        </p>
        <p>
          <h5>INDEMNITY</h5>
          All users and/or members herein agree to insure and hold GoalMogul
          Inc, our subsidiaries, affiliates, agents, employees, officers,
          ...
          or user of our site may submit, post, modify, transmit or otherwise
          make available through our Services, the use of GoalMogul Services or
          your connection with these Services, your violations of the Terms of
        ...
        <p>
          ...
          use of, or access to GoalMogul's sites.
        </p>
        <p>
          <h5>USE AND STORAGE GENERAL PRACTICES</h5>
          You herein acknowledge that GoalMogul Inc may set up any such
          ...
          posting or any other uploaded content shall be retained by GoalMogul
          Inc, nor the maximum number of email messages that may be sent and/or
          received by any member, the maximum volume or size of any email
          message that may be sent from or may be received by an account on our
          Service, the maximum disk space allowable that shall be allocated on
          GoalMogul Inc.'s servers on the member's behalf, and/or the maximum
          number of times and/or duration that any member may access our
          Services in a given period of time. In addition, you also agree that
          GoalMogul Inc has absolutely no responsibility or liability for the
          removal or failure to maintain storage of any messages and/or other
          communications or content maintained or transmitted by our Services.
          You also herein acknowledge that we reserve the right to delete or
          remove any account that is no longer active for an extended period of
          time. Furthermore, GoalMogul Inc shall reserve the right to modify,
        ...
        <p>
          ...
          allow you and the individuals with whom you communicate with the
          ability to save your conversations in your account located on
          GoalMogul Inc's servers. In this manner, you will be able to access
          and search your message history from any computer with internet
          access. You also acknowledge that others have the option to use and
          save conversations with you in their own personal account on
          http://www.goalmogul.com. It is your agreement to this TOS which
          establishes your consent to allow GoalMogul Inc to store any and all
          communications on its servers.
        </p>
        <p>
          <h5>MODIFICATIONS</h5>
          GoalMogul Inc shall reserve the right at any time it may deem fit, to
          modify, alter and or discontinue, whether temporarily or permanently,
        ...
        <p>
          <h5>TERMINATION</h5>
          As a member of http://www.goalmogul.com, you may cancel or terminate
        ...
        <p>
          As a member, you agree that GoalMogul Inc may, without any prior
          written notice, immediately suspend, terminate, discontinue and/or
          limit your account, any email associated with your account, and access
          to any of our Services. The cause for such termination,
          discontinuance, suspension and/or limitation of access shall include,
          but is not limited to:
        </p>
        <p>
          a) any breach or violation of our TOS or any other incorporated
        ...
        <p>
          ...
          connection with your http://www.goalmogul.com account Services.
        </p>
        <p>
        ...
        <p>
          ...
          any promotions of, advertisers located on or through our Services,
          which may include the payment and/or delivery of such related goods
          ...
          GoalMogul Inc shall not be held responsible or liable for any loss or
          damage of any nature or manner incurred as a direct result of any such
          dealings or as a result of the presence of such advertisers on our
          website.
        </p>
        <p>
          <h5>LINKS</h5>
          Either GoalMogul Inc or any third parties may provide links to other
          ...
          you acknowledge and agree that GoalMogul Inc shall not be responsible
          or liable, directly or indirectly, for any such damage or loss which
          may be a result of, caused or allegedly to be caused by or in
          connection with the use of or the reliance on any such content, goods
          or Services made available on or through any such site or resource.
        </p>
        <p>
          <h5>PROPRIETARY RIGHTS</h5>
          You do hereby acknowledge and agree that GoalMogul Inc's Services and
          ...
          applicable law or as authorized by GoalMogul Inc or such applicable
          ...
          plagiaristic works which are based on GoalMogul Inc Services (e.g.
          Content or Software), in whole or part.
        </p>
        <p>
          GoalMogul Inc herein has granted you personal, non-transferable and
          non-exclusive rights and/or license to make use of the object code or
        ...
        <p>
          Lastly, you also agree not to access or attempt to access our Services
          through any means other than through the interface which is provided
          by GoalMogul Inc for use in accessing our Services.
        </p>
        <p>
          <h5>WARRANTY DISCLAIMERS</h5>
          YOU HEREIN EXPRESSLY ACKNOWLEDGE AND AGREE THAT:
        </p>
        <p>
          a) THE USE OF GoalMogul Inc SERVICES AND SOFTWARE ARE AT THE SOLE RISK
          BY YOU. OUR SERVICES AND SOFTWARE SHALL BE PROVIDED ON AN "AS IS"
          AND/OR "AS AVAILABLE" BASIS. GoalMogul Inc AND OUR SUBSIDIARIES,
        ...
        <p>
          b) GoalMogul Inc AND OUR SUBSIDIARIES, OFFICERS, EMPLOYEES, AGENTS,
          PARTNERS AND LICENSORS MAKE NO SUCH WARRANTIES THAT (i) GOALMOGUL INC.
          SERVICES OR SOFTWARE WILL MEET YOUR REQUIREMENTS; (ii) GoalMogul Inc
          ...
          OF THE GoalMogul Inc SERVICES OR SOFTWARE WILL BE ACCURATE OR
        ...
        <p>
          ...
          OF GoalMogul Inc SERVICES OR SOFTWARE SHALL BE ACCESSED BY YOUR SOLE
          DISCRETION AND SOLE RISK, AND AS SUCH YOU SHALL BE SOLELY RESPONSIBLE
          ...
          DOWNLOADING AND/OR DISPLAYING, OR FOR ANY LOSS OF DATA THAT COULD
        ...
        <p>
          ...
          MAY BE OBTAINED BY YOU FROM GoalMogul Inc OR BY WAY OF OR FROM OUR
        ...
        <p>
          ...
          BACKGROUNDS THAT MAY BE CONTAINED ON A COMPUTER SCREEN OR WHILE USING
          OUR SERVICES. CERTAIN CONDITIONS MAY INDUCE A PREVIOUSLY UNKNOWN
          CONDITION OR UNDETECTED EPILEPTIC SYMPTOM IN USERS WHO HAVE SHOWN NO
          HISTORY OF ANY PRIOR SEIZURE OR EPILEPSY. SHOULD YOU, ANYONE YOU KNOW
          OR ANYONE IN YOUR FAMILY HAVE AN EPILEPTIC CONDITION, PLEASE CONSULT A
          PHYSICIAN IF YOU EXPERIENCE ANY OF THE FOLLOWING SYMPTOMS WHILE USING
          OUR SERVICES: DIZZINESS, ALTERED VISION, EYE OR MUSCLE TWITCHES, LOSS
          OF AWARENESS, DISORIENTATION, ANY INVOLUNTARY MOVEMENT, OR
          CONVULSIONS.
        </p>
        <p>
          <h5>LIMITATION OF LIABILITY</h5>
          YOU EXPLICITLY ACKNOWLEDGE, UNDERSTAND AND AGREE THAT GoalMogul Inc
        ...
        <p>
          <h5>RELEASE</h5>
          In the event you have a dispute, you agree to releaseGoalMogul Inc
          (and its officers, directors, employees, agents, parent subsidiaries,
        ...
        <p>
          ...
          the phrase "Let the investor beware" is appropriate. GoalMogul Inc's
          content is provided primarily for informational purposes, and no
          content that shall be provided or included in our Services is intended
          for trading or investing purposes. GoalMogul Inc and our licensors
          shall not be responsible or liable for the accuracy, usefulness or
          availability of any information transmitted and/or made available by
          way of our Services, and shall not be responsible or liable for any
          trading and/or investment decisions based on any such information.
        </p>
        <p>
          <h5>EXCLUSION AND LIMITATIONS</h5>
        ...
        <p>
          <h5>NOTICE</h5>
          GoalMogul Inc may furnish you with notices, including those with
          regards to any changes to the TOS, including but not limited to email,
        ...
        <p>
          ...
          You herein acknowledge, understand and agree that all of theGoalMogul
          Inc trademarks, copyright, trade name, service marks, and other
          GoalMogul Inc logos and any brand features, and/or product and service
          names are trademarks and as such, are and shall remain the property of
          GoalMogul Inc. You herein agree not to display and/or use in any
          manner theGoalMogul Inc logo or marks without obtaining GoalMogul
        ...
        <p>
          ...
          GoalMogul Inc will always respect the intellectual property of others,
          and we ask that all of our users do the same. With regards to
          appropriate circumstances and at its sole discretion, GoalMogul Inc
          may disable and/or terminate the accounts of any user who violates our
          TOS and/or infringes the rights of others. If you feel that your work
        ...
        <p>
          The GoalMogul Inc Agent for notice of claims of copyright or other
        ...
        <p>
          ...
          <br />
          ATTN: Todd J. Braverman, Esq.
          <br />
          1500 Broadway, 12th Floor, New York, NY 10036
          <br />
          Phone: 516-567-2416
          <br />
          E-mail: tbraverman@pearlcohen.com
          <br />
          CC: support@goalmogul.com
          <br />
        </p>
        <p>
          <h5>CLOSED CAPTIONING</h5>
          BE IT KNOWN, that GoalMogul Inc complies with all applicable Federal
          Communications Commission rules and regulations regarding the closed
          captioning of video content. For more information, please visit our
          website at http://www.goalmogul.com.
        </p>
        <p>
          ...
          This TOS constitutes the entire agreement between you andGoalMogul Inc
          and shall govern the use of our Services, superseding any prior
          version of this TOS between you and us with respect to GoalMogul Inc
          Services. You may also be subject to additional terms and conditions
          that may apply when you use or purchase certain other GoalMogul Inc
          Services, affiliate Services, third- party content or third-party
          software.
          <h5>
            <em>CHOICE OF LAW AND FORUM</em>
          </h5>
          It is at the mutual agreement of both you andGoalMogul Inc with regard
          to the TOS that the relationship between the parties shall be governed
          by the laws of the state of Delaware without regard to its conflict of
          law provisions and that any and all claims, causes of action and/or
          disputes, arising out of or relating to the TOS, or the relationship
          between you andGoalMogul Inc., shall be filed within the courts having
          jurisdiction within the County of, Delaware or the U.S. District Court
          located in said state. You and GoalMogul Inc agree to submit to the
          jurisdiction of the courts as previously mentioned, and agree to waive
          any and all objections to the exercise of jurisdiction over the
          parties by such courts and to venue in such courts.
          <h5>
            <em>WAIVER AND SEVERABILITY OF TERMS</em>
          </h5>
          At any time, should GoalMogul Inc fail to exercise or enforce any
          right or provision of the TOS, such failure shall not constitute a
          waiver of such right or provision. If any provision of this TOS is
          ...
          <h5>
            <em>NO RIGHT OF SURVIVORSHIP NON TRANSFERABILITY</em>
          </h5>
          ...
          to the use of our Services or the TOS must be filed within 2 year(s)
          after said claim or cause of action arose or shall be forever barred.
        </p>
        <p>
          <h5>VIOLATIONS</h5>
          Please report any and all violations of this TOS toGoalMogul Inc as
          follows:
        </p>
        <p>Mailing Address:</p>
        <p>
          ...
          <br />
          Telephone: ‪(929) 242-9293‬
          <br />
          Email: support@goalmogul.com
          <br />
        </p>
      </main>
    )
